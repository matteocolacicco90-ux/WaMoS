...
# -----------------------------
use_csv_signal = False   # True = load CSV, False = use synthetic model
csv_file = "detector_signal.csv"

if use_csv_signal:
    # CSV must have columns: time, signal
    ...
    # Use the approximated trend as the base signal
    S_t = poly_fit
else:
...
f_mod = 1234        # modulation frequency [Hz]
mod_depth = 0.05
